...
<div class="catagoriesbody">
   ...
   <div class="catagoriesleft">

      <P> <h1>     Courses  ❤️   </h1>  </P>

      <p class="coursetxt">These are many courses in our web site these are the best <br> courses, but you have acsess to More Than 10 Courses.<br>😯Unbelelivable aa..<br><br>All of these are Free!</p>

  </div>

   <div class="catagoriesright">

     <article class="catagory">

         <span class="catagoryicon"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-filetype-html" viewBox="0 0 16 16">
          <path fill-rule="evenodd" d="M14 4.5V11h-1V4.5h-2A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v9H2V2a2 2 0 0 1 2-2h5.5zm-9.736 7.35v3.999h-.791v-1.714H1.79v1.714H1V11.85h.791v1.626h1.682V11.85h.79Zm2.251.662v3.337h-.794v-3.337H4.588v-.662h3.064v.662zm2.176 3.337v-2.66h.038l.952 2.159h.516l.946-2.16h.038v2.661h.715V11.85h-.8l-1.14 2.596H9.93L8.79 11.85h-.805v3.999zm4.71-.674h1.696v.674H12.61V11.85h.79v3.325Z"/>
        </svg></span>
         <h5>HTML</h5>
         <p>HTML is the language for builging<br>web pages</p><br>
         <button class="startbtn"><a href="#">Start course</a></button>

     </article>

    <article class="catagory">

      <span class="catagoryicon"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-filetype-css" viewBox="0 0 16 16">
      ...
      <h5>CSS</h5>
      <p>CSS is the language for styling<br>web pages</p><br>
      <button class="startbtn"><a href="#">Start course</a></button>
    ...
    <article class="catagory">
      ...
      <span class="catagoryicon"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-filetype-js" viewBox="0 0 16 16">
      ...
      <h5>JavaScript</h5>
      <p>JavaScript is the language for progamming<br>web pages</p><br>
      <button class="startbtn"><a href="#">Start course</a></button>
    ...
    <article class="catagory">
      ...
      <span class="catagoryicon"> </span>
      <h5>Graphic designing</h5>
      <p>This is just amaazing<br>designing subject</p><br>
      <button class="startbtn"><a href="#">Start course</a></button>
      ...
      <article class="catagory">
        ...
        <span class="catagoryicon"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-controller" viewBox="0 0 16 16">
        ...
        <h5>Game Devoloping</h5>
        <p>Want to make your own game <br>Here you go</p><br>
        <button class="startbtn"><a href="#">Start course</a></button>
